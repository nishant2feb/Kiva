...
datatable(summary(Loan), style = "bootstrap", class = "table-condensed", options = list(dom = 'tp', scrollX = T))
...
```{r, message=FALSE, warning=FALSE}
 ...
 p = ggplot(data, aes(x = loan_amount, y = Year_mon, shape = repayment_interval)) +
  geom_point(aes(col = as.factor(gender)))+
  scale_x_discrete("Loan Amount")+
