...
for (i in (1:435764))
  Loan_10$gender_d[i] = gender[[i]][1]

ggplot(Loan_10, aes(x = loan_amount, y = Year_mon, shape = repayment_interval)) +
  geom_point(aes(col = as.factor(gender_d)))+
  scale_y_discrete("Year Month")+
  facet_wrap(~ country)+
